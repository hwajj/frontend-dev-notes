...
> **관련 문서:** [등록 퍼널·단계 시간 — URL만으로는 부족한 이유](./2026-06-09_ga4-funnel-custom-events.md)
...
1. GA4 관리자에서 위 이벤트 **맞춤 정의** 등록
2. Looker Studio 퍼널·전환율·전주 대비 차트 구성 (경영 공유 URL)
3. 이탈 상위 단계에 대해 Clarity 세션 필터링
4. (선택) BigQuery Export 후 단계 간 소요 시간 중앙값·백분위 SQL 정의
...
- 개념·배경: [2026-06-09_ga4-funnel-custom-events.md](./2026-06-09_ga4-funnel-custom-events.md)
